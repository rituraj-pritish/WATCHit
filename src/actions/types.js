...
export const ADD_TV_TO_FAVOURITE = 'ADD_TV_TO_FAVOURITE';
export const REMOVE_TV_FROM_FAVOURITE = 'REMOVE_TV_FROM_FAVOURITE';
...
export const REMOVE_CURRENT_PERSON = 'REMOVE _CURRENT_PERSON';

export const SET_CURRENT_TV = 'SET_CURRENT_TV';
export const SET_DISCOVER_TV = 'SET_DISCOVER_TV';
export const REMOVE_CURRENT_TV = 'REMOVE _CURRENT_TV';
